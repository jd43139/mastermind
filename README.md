...
-If the feedback section displays nR it means n digits included in the code but is not in the right position.(n represents the number of the digits).

-This process is repeated until the code breaker matches the code exactly or exceeds 12 trials.
